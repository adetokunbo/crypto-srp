...
-- | A large safe prime (from RFC 5054, 1536-bit group)
n1536Bits :: ByteString
n1536Bits =
...
-- | A large safe prime (from RFC 5054, 2048-bit group)
n2048Bits :: ByteString
n2048Bits =
...
-- | A large safe prime (from RFC 5054, 3072-bit group)
n3072Bits :: ByteString
n3072Bits =
...
-- | A large safe prime (from RFC 5054, 4096-bit group)
n4096Bits :: ByteString
n4096Bits =
  "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD129024E08"
    <> "8A67CC74020BBEA63B139B22514A08798E3404DDEF9519B3CD3A431B"
    <> "302B0A6DF25F14374FE1356D6D51C245E485B576625E7EC6F44C42E9"
...
-- | A large safe prime (from RFC 5054, 6144-bit group)
n6144Bits :: ByteString
n6144Bits =
  "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD129024E08"
    <> "8A67CC74020BBEA63B139B22514A08798E3404DDEF9519B3CD3A431B"
    <> "302B0A6DF25F14374FE1356D6D51C245E485B576625E7EC6F44C42E9"
...
-- | A large safe prime (from RFC 5054, 8192-bit group)
n8192Bits :: ByteString
n8192Bits =
  "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD129024E08"
    <> "8A67CC74020BBEA63B139B22514A08798E3404DDEF9519B3CD3A431B"
    <> "302B0A6DF25F14374FE1356D6D51C245E485B576625E7EC6F44C42E9"
